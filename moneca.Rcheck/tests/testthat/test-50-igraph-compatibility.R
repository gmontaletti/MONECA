# Unit Tests: igraph Compatibility Layer
# ========================================
#
# Tests for the igraph version compatibility functions that ensure
# the package works with both old and new igraph APIs.

test_that("igraph compatibility functions work correctly", {
  # Create a simple test matrix
  test_matrix <- create_test_adjacency(n = 3, type = "simple")
...
test_that("moneca_get_edgelist works correctly", {
  ...
  test_matrix <- create_test_adjacency(n = 3, type = "directed")
...
test_that("weighted graph creation works", {
  ...
  weighted_matrix <- create_test_adjacency(n = 3, type = "weighted")
