...
### Data Generation
- **generate_mobility_data()** - Create synthetic mobility matrices for testing

### Modern Visualization (ggraph-based)
- **plot_moneca_ggraph()** - Network visualization with segment highlighting
- **plot_ego_ggraph()** - Ego network analysis and visualization
- **plot_stair_ggraph()** - Multi-level hierarchical segmentation plots
- **plot_moneca_dendrogram()** - Dendrogram visualization of hierarchical structure
...
### Auto-Tuning
- **auto_tune_small_cell_reduction()** - Automatic parameter optimization
...
R package version 1.0.2. https://github.com/gmontaletti/moneca
